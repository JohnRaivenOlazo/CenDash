...
$query_res = mysqli_query($db, "SELECT * FROM foods ORDER BY RAND() LIMIT 6");
$res = mysqli_query($db, "select * from vendor_group");
$ress = mysqli_query($db, "select * from vendor");
?>
<!DOCTYPE html>
<html lang="en">
...
<nav class="nav" id="nav">
    <div class="nav-container">
        ...
        <section class="hero">
            <h1>CenDash <br>Make Dining Easier</h1>
            <img class="bg" src="src/assets/images/header-bg.jpg">
            <img class="trees" src="src/assets/images/Trees.png">
        </section>
            ...
            <div class="food-item-container">
                ...
                <div class="food-item">
                        <div class="figure-wrap">
                            <img src="../src/assets/vendorassets/foods/' . $r['img'] . '" alt="">
                        </div>
                        <div class="content">
        ...
        <section class="about">
            <div class="col1">
                <div class="step step-1">
                    ...
                    <p>We"ve got your covered with menus from our selected vendors.</p>
                </div>
            </div>
            <div class="col2">
                <div class="step step-2">
                    ...
                    <h3>Pick food!</h3>
                    <p>We"ve got your covered with a variety of vendors in our market.</p>
                </div>
            </div>
            <div class="col3">
                <div class="step step-3">
                    ...
                    <h3>Order and Pay!</h3>
                    <p>Get your food! We accept Dine in or Take Out!</p>
                </div>
            </div>
        </section>
        <section class="vendor-view">
            ...
            <div class="vendor-filter">
                <div class="filter">
                    <li><a type="button" data-filter="*">All</a></li>
                    <?php
                    while ($row = mysqli_fetch_array($res)) {
                        echo '<li><a data-filter=".' . $row['c_name'] . '">' . $row['c_name'] . '</a></li>';
                    }
                    ?>
                </div>
            </div>
            <div class="sort-container">
                ...
                while ($rows = mysqli_fetch_array($ress)) {
                    $query = mysqli_query($db, "select * from vendor_group where c_id='" . $rows['c_id'] . "' ");
                    $rowss = mysqli_fetch_array($query);
                    echo
                    ' 
                <div class="vendor-wrap all ' . $rowss['c_name'] . '">
                    <div>
                        <a class="logo" href="foods.php?res_id=' . $rows['rs_id'] . '" >
                        <img src="../src/assets/vendorassets/' . $rows['image'] . '">
                    </a>
                    </div>
                    <div>
                        <h5>
                        <a href="foods.php?res_id=' . $rows['rs_id'] . '" >' . $rows['title'] . '</a>
                    </h5> 
                    </div>
                </div>
            ';
