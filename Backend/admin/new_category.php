...
if (isset($_POST['submit'])) {
    if (empty($_POST['c_name'])) {
        ...
        $check_cat = mysqli_query($db, "SELECT c_name FROM vendor_group where c_name = '" . $_POST['c_name'] . "' ");
        if (mysqli_num_rows($check_cat) > 0) {
            ...
            $mql = "INSERT INTO vendor_group(c_name) VALUES('" . $_POST['c_name'] . "')";
            mysqli_query($db, $mql);
...
if (isset($_GET['cat_del'])) {
    mysqli_query($db, "DELETE FROM vendor_group WHERE c_id = '" . $_GET['cat_del'] . "'");
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive m-t-40">
                                <table id="myTable" class="table table-bordered table-hover table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                        $sql = "SELECT * FROM vendor_group order by c_id desc";
